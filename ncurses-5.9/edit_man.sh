...
*.[0-9]*)
	...
	if test ! -f /Users/mcciupek/Documents/42/minishell_shared/ncurses-5.9/man_alias.sed ; then
cat >>/Users/mcciupek/Documents/42/minishell_shared/ncurses-5.9/man_alias.sed <<-CF_EOF2
		s,@DATADIR@,$datadir,g
...
s,@TSET@,tset,g
CF_EOF2
		echo "...made /Users/mcciupek/Documents/42/minishell_shared/ncurses-5.9/man_alias.sed"
	fi
	...
	aliases=`sed -f $top_srcdir/man/manlinks.sed $inalias |sed -f /Users/mcciupek/Documents/42/minishell_shared/ncurses-5.9/man_alias.sed | sort -u`
	...
	sed	-f /Users/mcciupek/Documents/42/minishell_shared/ncurses-5.9/man_alias.sed \
		< $i >$TMP
